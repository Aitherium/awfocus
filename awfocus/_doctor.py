"""Stack-aware `doctor` for awfocus.
...
interesting failures live BETWEEN them. "awfocus is installed" is not the useful
fact -- "awfocus is installed and the thing it pairs with is not" is. This reports
...
#: gets ignored.
ENV_REQUIRED = []
ENV_OPTIONAL = ['AWFOCUS_PROJECTS_DIR', 'AWFOCUS_SESSIONS_DIR', 'AWFOCUS_STATE_DIR']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awfocus needs at runtime, and a
